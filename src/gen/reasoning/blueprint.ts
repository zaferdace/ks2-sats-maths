...
export const REASONING_BLUEPRINT: readonly ReasoningSlot[] = [
  ...
  one(o('r-bar-chart', 1), o('r-table', 1), o('r-line-graph', 1)),
  two(o('r-money', 1, 2), o('r-multistep', 1)),
  two(o('r-fraction-context', 1), o('r-percent-context', 1), o('r-recipe', 1, 2)),
  // Day 2
  one(o('r-negative', 1, 2), o('r-order-numbers', 1)),
  one(o('r-shaded', 1, 2), o('r-compare-fractions', 1)),
  one(o('r-coordinates', 1), o('r-transform', 1)),
  two(o('r-recipe', 2), o('r-ratio-share', 1, 2)),
  two(o('r-inverse', 1, 2), o('r-formula', 1, 2)),
  // Day 3
  one(o('r-factors', 1, 2), o('r-estimate', 1, 2)),
  one(o('r-convert', 1, 2), o('r-decimal-context', 1, 2)),
  one(o('r-line-graph', 1, 2), o('r-pie-chart', 1, 2)),
  two(o('r-money', 2), o('r-multistep', 2), o('r-remainders', 2, 3)),
  two(o('r-time', 1, 2), o('r-perimeter-area', 2)),
  // Day 4
  one(o('r-equation', 1, 2), o('r-pattern', 1, 2), o('r-sequence', 1, 2)),
  one(o('r-angles-polygon', 1, 2), o('r-shapes', 2), o('r-angles-line', 2)),
  one(o('r-fdp', 1, 2), o('r-scale', 1, 2), o('r-shaded', 3)),
  two(o('r-percent-context', 2, 3), o('r-fraction-context', 2, 3)),
  two(o('r-perimeter-area', 3), o('r-volume', 1, 2, 3)),
  // Day 5: hardest
  ...
  two(o('r-two-unknowns', 1, 2, 3), o('r-money', 3), o('r-multistep', 3), o('r-inverse', 3), o('r-sequence', 3), o('r-equation', 3)),
];
